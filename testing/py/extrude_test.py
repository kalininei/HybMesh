...
s1 = hm.extrude_grid(g1, [-0.1, 0.1, 0.2, 0.3],
                     ...
                     7, None)
hm.export3d_grid_vtk(s1, None, "s2.vtk")
hmdbg.check_ascii_file(13083658888686364505, "s2.vtk")
hm.remove_geom(s1)
...
s1 = hm.extrude_grid(g1, [0.0, 0.1],
                     ...
                     None)
hm.export3d_grid_vtk(s1, None, "s2.vtk")
hmdbg.check_ascii_file(8838282699817271593, "s2.vtk")
hm.remove_geom(s1)
...
hm.export3d_grid_vtk(s1, None, "s2.vtk")
hmdbg.check_ascii_file(97869039922761332, "s2.vtk")
hm.remove_geom(s1)
