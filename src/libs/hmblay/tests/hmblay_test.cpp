...
void test13(){
	...
	//gcommon
	auto gr1 = GridGeom::cross_grids(&g1, &g5, 0.3, 7, false, false, 0, HMCallback::to_cout2);
	auto gr2 = GridGeom::cross_grids(gr1, &g4, 0.1, 7, false, false, 0, HMCallback::to_cout2);
...
void test16(){
	...
	GridGeom* impgrid = GridGeom::cross_grids(&gcirc, &bgrid, 0.3, 7,
			false, false, 0, HMCallback::to_cout2);
