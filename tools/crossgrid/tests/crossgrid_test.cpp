...
void test2(){
	...
	Grid* res = cross_grids(gmain, gsec, 0.05, 0.5, 1, 0);
...
void test3(){
	...
	Grid* res = cross_grids(gmain, gsec, 0.15, 0.5, 1, 0);
...
void test4(){
	...
	Grid* res = cross_grids(gmain, gsec, 0.2, 0.5, 1, 0);
...
void test5(){
	...
	Grid* res = cross_grids(gmain, gsec, 2.0, 0.5, 1, 0);
...
void test6(){
	...
	Grid* res = cross_grids(gmain, gsec, 0.3, 0.1, 1, 0);
	grid_save_vtk(res,"out_res6_1.vtk");
	grid_free(res);

	res = cross_grids(gmain, gsec, 0.3, 0.5, 1, 0);
	grid_save_vtk(res,"out_res6_5.vtk");
	grid_free(res);

	res = cross_grids(gmain, gsec, 0.3, 0.9, 1, 0);
...
void test7(){
	...
	Grid* res = cross_grids(gmain, gsec, 0.2, 0.5, 1, 0);
	Grid* res2 = cross_grids(res, gsec2, 0.2, 0.5, 1, 0);
	Grid* res3 = cross_grids(res2, gsec3, 0.2, 0.5, 1, 0);
...
void test8(){
	...
	Grid* res = cross_grids(gmain, gsec, 0.2, 0.5, 1, 0);
	Grid* res2 = cross_grids(res, gsec2, 0.2, 0.5, 1, 0);
	//frontal triangulation
	//add_check(grid_npoints(res2)==1361 && grid_ncells(res2)==1432, "grid topology");
	//delaunay
	add_check(grid_npoints(res2)==1377 && grid_ncells(res2)==1464, "grid topology");
...
void test9(){
	...
	Grid* res = cross_grids(gmain, gsec, 0.2, 0.5, 1, 0);
	Grid* res2 = cross_grids(gmain, gsec, 0.2, 0.5, 0, 0);
...
void test10(){
	...
	Grid* res = cross_grids(gmain, gsec, 1.0, 0.5, 1, 0);
	Grid* res2 = cross_grids(gmain, gsec, 1.0, 0.5, 0, 0);
...
void test17(){
	...
	Grid* unig = cross_grids(bigg, smallg, 0.2, 0.5, 1, 0);
...
void test19(){
	...
	auto g3 = cross_grids(g1, g2, 0.1, 0.5, 0, 0); 
	add_check(grid_ncells(g3) == 280 && grid_npoints(g3) == 268, "resulting topology");
...
void test20(){
	...
	auto g6 = cross_grids(g5, g4, 0.1, 0.5, 0, 1);
