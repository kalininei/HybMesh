...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lst_used.setGeometry(QtCore.QRect(4, 136, 101, 191))
        ...
        self.lst_unused.setGeometry(QtCore.QRect(152, 136, 111, 191))
        ...
        self.bt_left.setGeometry(QtCore.QRect(114, 192, 31, 25))
        ...
        self.bt_right.setGeometry(QtCore.QRect(114, 220, 31, 25))
        ...
        self.cb_preserve = QtGui.QCheckBox(Dialog)
        self.cb_preserve.setGeometry(QtCore.QRect(3, 103, 191, 21))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.cb_preserve.setText(_translate("Dialog", "Preserve all boundary nodes", None))
